...
infiles=FileNames["mat*.in"];
        ...
        rho1[K1_,K2_,K3_,K4_,w12_,w13_,w14_,w23_,w24_,w34_,w123_,w124_,w134_,w234_,w1234_,wp1_,wp2_,wp3_,wp4_,wp12_,wp13_,wp14_,wp23_,wp24_,wp34_,wp123_,wp124_,wp134_,wp234_,wp1234_,P_,x_]:=(1)*x^0;
...
maxX = f[x]/. {x -> $MaxMachineNumber};
halfX = Solve[f[x]==maxX*0.5&&x>0,x];
