...
import TFA4_TFB2_allornone

instance=TFA4_TFB2_allornone.GRFCalculations_ld_50_15()
B=np.array([1])

def func(pars):
    out=[None,None]
    instance.fill_num_den(pars,B)
