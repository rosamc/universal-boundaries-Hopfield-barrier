...
mat=np.load("mat_topleft_N4univ_init.npy")
mat_pars=np.load("mat_pars_topleft_N4univ_init.npy")

pos_ar=np.arange(0,0.21,0.01)
stp_ar=np.arange(1.6,10,0.02)
...
constraints={1:{'target':0,'lt':1},3:{'target':2,'lt':1},
                5:{'target':4,'lt':1},7:{'target':6,'lt':1},9:{'target':8,'lt':1}}
